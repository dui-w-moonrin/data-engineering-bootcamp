...
keyfile = "deb-loading-data-to-bigquery-secured.json" # 🚨 แก้ไขชื่อ keyfile ให้ถูกต้อง
service_account_info = json.load(open(keyfile))
credentials = service_account.Credentials.from_service_account_info(service_account_info)
project_id = "dui-bootcamp" # 🚨 แก้ไข project_id ให้สอดคล้องกับ GCP project ของตัวเอง
